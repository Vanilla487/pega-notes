export default function Article() {
  return (
    // 1. The Main Wrapper: Adds breathing room around the whole article
    <article className="px-6 py-12 md:px-16">
      <div className="mx-auto max-w-5xl">
        {/* TOP SECTION: Category & Titles */}
        <header className="mb-8">
          <span className="mb- block font-mono text-xs tracking-widest text-brand-light uppercase opacity-50">
            · Best Practices
          </span>
          <h1 className="mb-2 text-4xl text-[64px] font-bold text-brand-dark">
            Error Handling within Data Flows
          </h1>
          <p className="font-mono text-lg text-[24px] leading-relaxed font-medium text-brand-muted opacity-80">
            How to properly report an error during processing Activities/ Data
            Transforms within Data Flows
          </p>
        </header>

        {/* BODY SECTION: The content blocks */}
        <section className="space-y-10">
          {/* A Content Block Group */}
          <div className="group">
            <p className="mb-3 text-lg leading-relaxed text-brand-dark">
              ...
              Bonorum et Malorum", written by Cicero in 45 BC Lorem ipsum dolor
              ...
              written by Cicero in 45 BC Lorem ipsum dolor sit amet, consectetur
            ...
            <footer className="text-sm font-medium opacity-60">
